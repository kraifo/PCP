...
verbose=1
sourceId='champpenal'
targetDir="./data/champpenal/html"
url='http://journals.openedition.org/champpenal/'
urlPattern=qr/http:..journals.openedition.org.champpenal.\d+$/
...
inputDir="./data/champpenal/html"
outputDir="./data/champpenal/html2"
filePattern=qr/html$/
...
inputDir="./data/champpenal/html2"
outputDir="./data/champpenal/txt"
filePattern=qr/html$/
...
outputDir="./data/champpenal/para"
filePattern=qr/txt$/
...
inputDir='./data/champpenal/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/champpenal/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/champpenal/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
