...
verbose=1
sourceId='brussels'
targetDir="./data/brussels/html"
url='http://journals.openedition.org/brussels/'
urlPattern=qr/http:..journals.openedition.org.brussels.\d+$/
...
inputDir="./data/brussels/html"
outputDir="./data/brussels/html2"
filePattern=qr/html$/
...
inputDir="./data/brussels/html2"
outputDir="./data/brussels/txt"
filePattern=qr/html$/
...
inputDir='./data/brussels/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/brussels/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/brussels/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
