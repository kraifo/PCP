...
verbose=1
sourceId='clio'
targetDir="./data/clio/html"
url='https://www.cairn.info/revue-clio-femmes-genre-histoire.htm'
urlPattern=qr/https:..www.cairn.info.revue-clio-femmes-genre-histoire-2014|https:..www.cairn-int.info.article-E_CLIO1_/

resetCrawling=1
limitDepth=3
downloadIfAligned=1
alignedUrlWithContextPatterns={fr=>qr/<div class="frenchVersion">\s*<a href="(.*?)"/}
# alignedUrlTransformationScheme={'en'=>[qr/(http:.*\d+)/,'$1?lang=en']}
contentPattern=qr/<meta http-equiv="Content-language" content="(?:fr|en)" \/>.*<div id="text" class="section">(?<content>.*)<\/div><!-- #text -->|<!-- DEBUT CORPS -->(?<content>.*)<!-- FIN CORPS -->/s
namePattern=[qr/<meta name="og:title" content="(.*?)">/]
nameBase='content'
inputEncoding='utf8'
outputEncoding='utf8'
metadataPatterns=[
...
inputDir="./data/clio/html"
outputDir="./data/clio/html2"
filePattern=qr/html$/
outputFileName=[qr/[.]html/,'.html']
searchReplacePatterns=[
	[qr/<div class="textIcon">(.*)<\/div>/,""]
	]
