windows=0
verbose=1
sourceId='communiquer'
targetDir="./data/communiquer/html"
url='http://journals.openedition.org/communiquer/'
urlPattern=qr/http:..journals.openedition.org.communiquer.\d+$/
...
inputDir="./data/communiquer/html"
outputDir="./data/communiquer/html2"
filePattern=qr/html$/
...
inputDir="./data/communiquer/html2"
outputDir="./data/communiquer/txt"
filePattern=qr/html$/
...
outputDir="./data/communiquer/para"
filePattern=qr/txt$/
...
outputDir="./data/communiquer/tok"
language='fr'
...
outputDir="./data/communiquer/ttg"
...
filePattern=qr/(.*).ttg$/
outputDir="./data/communiquer/tei"
outputFileName=[qr/(.*).ttg$/i,'$1.xml']
dataFilePattern=[qr/ttg\/(.*extract.\w\w)[.]ttg/,'html/$1.html.meta']
data={
	'h.title'=>"Corpus Bilingue Revue de communication sociale et publique Communiquer",
...
inputDir='./data/communiquer/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/communiquer/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/communiquer/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
