...
verbose=1
sourceId='eue'
targetDir="./data/eue/html"
url='http://journals.openedition.org/eue/'
urlPattern=qr/http:..journals.openedition.org.eue.\d+$/
...
inputDir="./data/eue/html"
outputDir="./data/eue/html2"
filePattern=qr/html$/
...
inputDir="./data/eue/html2"
outputDir="./data/eue/txt"
filePattern=qr/html$/
...
inputDir='./data/eue/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/eue/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
