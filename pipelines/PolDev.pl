...
verbose=1
sourceId='poldev'
targetDir="./data/poldev/html"
url='http://journals.openedition.org/poldev/'
urlPattern=qr/http:..journals.openedition.org.poldev.\d+$/
...
inputDir="./data/poldev/html"
outputDir="./data/poldev/html2"
filePattern=qr/html$/
...
inputDir="./data/poldev/html2"
outputDir="./data/poldev/txt"
filePattern=qr/html$/
...
filePattern=qr/(.*).ttg$/
outputDir="./data/poldev/tei"
outputFileName=[qr/(.*).ttg$/i,'$1.xml']
dataFilePattern=[qr/ttg\/(.*extract.\w\w)[.]ttg/,'html/$1.html.meta']
data={
	'h.title'=>"Corpus Bilingue Revue Internationale de Politique de Développement",
...
inputDir='./data/poldev/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/poldev/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/poldev/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
