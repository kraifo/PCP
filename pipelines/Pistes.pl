...
verbose=1
sourceId='pistes'
targetDir="./data/pistes/html"
url='http://journals.openedition.org/pistes/'
urlPattern=qr/http:..journals.openedition.org.pistes.\d+$/
...
inputDir="./data/pistes/html"
outputDir="./data/pistes/html2"
filePattern=qr/html$/
...
inputDir="./data/pistes/html2"
outputDir="./data/pistes/txt"
filePattern=qr/html$/
...
inputDir='./data/pistes/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/pistes/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/pistes/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
