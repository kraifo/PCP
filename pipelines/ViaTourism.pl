...
inputDir="./data/viaTourism/html"
outputDir="./data/viaTourism/html2"
filePattern=qr/html$/
outputFileName=[qr/[.]html/,'.html']
searchReplacePatterns=[
	[qr/<div class="textIcon">.*?<\/span><\/p><\/div>/""],
	#[,]
	]
...
outputDir="./data/viaTourism/para"
filePattern=qr/txt$/
...
inputDir='./data/viaTourism/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/viaTourism/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/viaTourism/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
