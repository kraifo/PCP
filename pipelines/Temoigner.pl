...
verbose=1
sourceId='temoigner'
targetDir="./data/temoigner/html"
url='http://journals.openedition.org/temoigner/'
urlPattern=qr/http:..journals.openedition.org.temoigner.\d+$/
...
inputDir="./data/temoigner/html"
outputDir="./data/temoigner/html2"
filePattern=qr/html$/
...
inputDir="./data/temoigner/html2"
outputDir="./data/temoigner/txt"
filePattern=qr/html$/
...
inputDir='./data/temoigner/ttg'
filePattern=qr/(.*)fr.ttg$/
outputDir='./data/temoigner/stats.fr'
inputFormat="ttg"
outputFormat="csv"
global=1
...
outputDir='./data/temoigner/stats.en'
inputFormat="ttg"
outputFormat="csv"
global=1
